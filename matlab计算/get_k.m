...
fprintf('fp32 a11[6] = {0,%.12f,%.12f,%.12f,%.12f};\n',a11(1),a11(2),a11(3),a11(4));
fprintf('fp32 a12[6] = {0,%.12f,%.12f,%.12f,%.12f};\n',a12(1),a12(2),a12(3),a12(4));
fprintf('fp32 a13[6] = {0,%.12f,%.12f,%.12f,%.12f};\n',a13(1),a13(2),a13(3),a13(4));
fprintf('fp32 a14[6] = {0,%.12f,%.12f,%.12f,%.12f};\n',a14(1),a14(2),a14(3),a14(4));
fprintf('fp32 a15[6] = {0,%.12f,%.12f,%.12f,%.12f};\n',a15(1),a15(2),a15(3),a15(4));
fprintf('fp32 a16[6] = {0,%.12f,%.12f,%.12f,%.12f};\n',a16(1),a16(2),a16(3),a16(4));

fprintf('fp32 a21[6] = {0,%.12f,%.12f,%.12f,%.12f};\n',a21(1),a21(2),a21(3),a21(4));
fprintf('fp32 a22[6] = {0,%.12f,%.12f,%.12f,%.12f};\n',a22(1),a22(2),a22(3),a22(4));
fprintf('fp32 a23[6] = {0,%.12f,%.12f,%.12f,%.12f};\n',a23(1),a23(2),a23(3),a23(4));
fprintf('fp32 a24[6] = {0,%.12f,%.12f,%.12f,%.12f};\n',a24(1),a24(2),a24(3),a24(4));
fprintf('fp32 a25[6] = {0,%.12f,%.12f,%.12f,%.12f};\n',a25(1),a25(2),a25(3),a25(4));
fprintf('fp32 a26[6] = {0,%.12f,%.12f,%.12f,%.12f};\n',a26(1),a26(2),a26(3),a26(4));
toc
